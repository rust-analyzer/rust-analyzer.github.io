...
Try **Rust Analyzer: Show RA Version** in VS Code (using **Command Palette** feature typically acticated by Ctrl+Shift+P) or `rust-analyzer --version` in the command line.
